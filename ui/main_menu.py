...
class MainMenu(QWidget):
    ...
    def create_app_name_container(self):
        container = self.create_main_menu_container()
    ...
    def create_user_selection_container(self):
        container = self.create_main_menu_container(grid=True)
    ...
    def create_buttons_container(self):
        ...
        self.settings_button = MainMenuButton('Settings')
        self.quit_button = MainMenuButton('Quit', 'quit_button')
    ...
    def create_main_menu_container(self, grid: bool = False):
        container = QWidget()
        container.setObjectName('main-menu-container')
